...
pi: yads.c
	...
	@$(CCC) $(CFLAGS) $(INC) $(LIB) $(LIBS) -o pi_yads yads.c modules/TIM.o modules/LET.o modules/LAB.o modules/DEC.o libs/menuLibPI.o libs/buttons.o libs/session.o libs/data.o 
